...
# RO=114 #|66|120 |114 #number of readout positions at each we have a hyber slice
    ...
    with device:
        ...
        # for RO_idx in range(RO_start,RO_end): #for testing just a few RO positions
            ...
            with h5py.File(DATA_DIR+infile_k,'r') as f:
                ...
                kdat_temp=np.concatenate((f['kdat_01'][...,RO_idx],  # all offsets
                                f['kdat_02'][...,RO_idx]),                
                                axis =0)
                ...
                # kdat_temp=f['kdat_01'][...,RO_idx][:]  # Sagital slices at a certain RO position for all reps in kdat01 
